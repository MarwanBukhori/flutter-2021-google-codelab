...
import 'package:flutter_codelab/models/wishlist_model.dart';
...
class WishlistBloc extends Bloc<WishlistEvent, WishlistState> {
  ...
  Stream<WishlistState> mapEventToState(
    ...
    if (event is StartWishlist) {
      ...
      yield* _mapRemoveWithlistProducttoState(event, state);
    }
  }
  ...
  Stream<WishlistState> _mapRemoveWithlistProducttoState(
